...
import { activateCodexProfile, CODEX_ACCOUNT_PROFILES, codexProfileHome } from "../index.ts"

test("exposes public account profile names", () => {
	assert.deepEqual(CODEX_ACCOUNT_PROFILES, ["personal", "business"])
})
