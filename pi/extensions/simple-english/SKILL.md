...
version: 1.2.0
description: |
  Check, write, or rewrite technical text with ASD-STE100 Simplified Technical
  English. Use only when the user invokes Simple English or explicitly asks to
  check or rewrite documentation, READMEs, runbooks, procedures, error messages,
  release notes, incident reports, or API guides. Also use for requests that say
