---
name: fastify
description: "Fastify guidance for Node.js backends and REST APIs using TypeScript or JavaScript. Use automatically for coding tasks when the repository depends on or imports from fastify, or when the task mentions Fastify. Covers routes, plugins, JSON Schema validation, errors, performance, authentication, CORS, security headers, databases, WebSockets, deployment, lifecycle hooks, serialization, Pino logging, and TypeScript integration."
metadata:
