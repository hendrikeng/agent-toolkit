...
Authenticate WebSocket connections with an HttpOnly session cookie after registering `@fastify/cookie`. Do not put reusable credentials in the WebSocket URL:
