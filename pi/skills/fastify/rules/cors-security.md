...
Configure exact trusted proxy addresses for reverse proxy environments:

```typescript
const app = Fastify({
  // Replace with the exact addresses or CIDRs of your proxies
  trustProxy: ['127.0.0.1'],
});

// Use trustProxy: true only when network policy prevents direct client access
...
const app = Fastify({
  trustProxy: ['127.0.0.1'], // Replace with the exact addresses of your proxies
